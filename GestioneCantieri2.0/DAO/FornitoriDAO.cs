...
{
    public class FornitoriDAO : DAOBase
    {
        ...
        public static List<TblForitoriModel> GetFornitori()
        {
            SqlConnection cn = GetConnection();
            string sql = "";
            ...
            try
            {
                ...
                return cn.Query<TblForitoriModel>(sql).ToList();
            }
            catch (Exception ex)
            {
                throw new Exception("Errore durante il recupero dei fornitori", ex);
        ...
        public static TblForitoriModel GetSingleFornitore(int idFornitore)
        {
            SqlConnection cn = GetConnection();
            string sql = "";
            ...
            try
            {
                ...
                return cn.Query<TblForitoriModel>(sql, new { IdFornitori = idFornitore }).SingleOrDefault();
            }
            catch (Exception ex)
            {
        ...
        public static bool InserisciFornitore(TblForitoriModel f)
        {
            SqlConnection cn = GetConnection();
            string sql = "";
        ...
        public static bool UpdateFornitore(TblForitoriModel f)
        {
            SqlConnection cn = GetConnection();
            string sql = "";
